   ...
   * A amostra vem de uma população aproximadamente normal?
   ...
   Graficamente, o intervalo de confiança corresponde à área em vermelho abaixo da seguinte distribuição $t$ padronizada, com $`r gl`$ graus de liberdade:
   ...
   Observe que [esta distribuição $t$ é padronizada: tem média $0$ e desvio padrão igual a $1$.]{.hl} Este é o costume ao plotar distribuições $t$.
